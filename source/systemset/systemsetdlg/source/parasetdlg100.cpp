/***********************************************
**  文件名:     parasetdlg100.cpp
**  功能:       参数设置界面-针对DN100检定台
...
#include "parasetdlg100.h"
#include "commondefine.h"
#include "qtexdb.h"
#include "algorithm.h"

ParaSetDlg100::ParaSetDlg100(QWidget *parent, Qt::WFlags flags)
	: QWidget(parent, flags)
{
	qDebug()<<"ParaSetDlg100 thread:"<<QThread::currentThreadId();
	ui.setupUi(this);
	...
	lastParams = new ParaSetReader100();
	flowPointVector();
	installLastParams();//加载上次的配置信息
	//m_standVerify = false;//默认不使用标准表检测法
}

ParaSetDlg100::~ParaSetDlg100()
{
	qDebug()<<"!!! ParaSetDlg100 destructor";
}

void ParaSetDlg100::on_btnExit_clicked()
{
	this->close();
}

void ParaSetDlg100::showEvent(QShowEvent * event)
{
}

void ParaSetDlg100::closeEvent(QCloseEvent * event)
{
	if (m_meterStdPtr)
	{
...
void ParaSetDlg100::showWaterPara()
{
	ui.gBoxWaterPara->show();
}

void ParaSetDlg100::on_cmbStandard_currentIndexChanged()
{
...
void ParaSetDlg100::installDftDBinfo()
{
...
//映射采集代码
void ParaSetDlg100::mapPickCodeModel()
{
...
//映射制造单位
void ParaSetDlg100::mapManuDeptModel()
{
...
//映射送检单位
void ParaSetDlg100::mapVfDeptModel()
{
...
//映射送检员和核验员
void ParaSetDlg100::mapUserModel()
{
...
//映射表型号
void ParaSetDlg100::mapMeterModelModel()
{
...
void ParaSetDlg100::initBtnGroup()
{
...
void ParaSetDlg100::slot_autopick_clicked(int id)
{
...
*/
void ParaSetDlg100::onVerifyFlowChanged(QString vFlow, int num)
{
	bool ok;
	...
	float bigUpperFlow = 0;//ui.lineEdit_Upper_1->text().toFloat();
	float mid2UpperFlow = 0;//ui.lineEdit_Upper_2->text().toFloat();
	float mid1UpperFlow = 0;//ui.lineEdit_Upper_3->text().toFloat();
	float smallUpperFlow = 0;//ui.lineEdit_Upper_4->text().toFloat();
...
void ParaSetDlg100::on_lnEdit_Flow1_textChanged(const QString & text)
{
	onVerifyFlowChanged(text, 0);
}

void ParaSetDlg100::on_lnEdit_Flow2_textChanged(const QString & text)
{
	onVerifyFlowChanged(text, 1);
}

void ParaSetDlg100::on_lnEdit_Flow3_textChanged(const QString & text)
{
	onVerifyFlowChanged(text, 2);
}

void ParaSetDlg100::on_lnEdit_Flow4_textChanged(const QString & text)
{
...
** num: 0-大管路；1-中二管路； 2-中一管路； 3-小管路 
*/
void ParaSetDlg100::onUpperFlowChanged()
{
...
void ParaSetDlg100::on_lineEdit_Upper_1_textChanged(const QString & text)
{
	onUpperFlowChanged();
}

void ParaSetDlg100::on_lineEdit_Upper_2_textChanged(const QString & text)
{
	onUpperFlowChanged();
}

void ParaSetDlg100::on_lineEdit_Upper_3_textChanged(const QString & text)
{
	onUpperFlowChanged();
}

void ParaSetDlg100::on_lineEdit_Upper_4_textChanged(const QString & text)
{
	onUpperFlowChanged();
}

void ParaSetDlg100::installLastParams()
{
	installHead();
	//installStdDevNo();
	installFlowPoint();
...
void ParaSetDlg100::installHead()
{
...
void ParaSetDlg100::installFlowPoint()
{
	// 第i流量点
	for (int i=0; i<VERIFY_POINTS; i++)
	{
...
void ParaSetDlg100::installBool()
{
	//自动采集
...
void ParaSetDlg100::installOther()
{
...
void ParaSetDlg100::installWaterPara()
{
...
** 将各流量点中, 相似功能的控件加入数组, 便于使用; 
   ...
   而每个控件代表记录中的不同的域
*/
void ParaSetDlg100::flowPointVector()
{
	//上限流量点
	lineEdit_uppers.append(ui.lineEdit_Upper_DN50_1);
	lineEdit_uppers.append(ui.lineEdit_Upper_DN50_2);
	lineEdit_uppers.append(ui.lineEdit_Upper_DN50_3);
	lineEdit_uppers.append(ui.lineEdit_Upper_DN25);
	lineEdit_uppers.append(ui.lineEdit_Upper_DN15_1);
	lineEdit_uppers.append(ui.lineEdit_Upper_DN15_2);
	//检测流量点
...
void ParaSetDlg100::on_btnSave_clicked()
{
	//先检查选定次序的合法性
	if (!chkSeq())
	{
...
bool ParaSetDlg100::chkTotalQuantity()
{
...
*/
void ParaSetDlg100::SaveFlowPoint()
{
...
void ParaSetDlg100::SaveWaterPara()
{
...
void ParaSetDlg100::Update_T_Meter_Default_Params()
{
...
/*************************************************************************
************************ParaSetReader100 Start*************************
**************************************************************************/
ParaSetReader100::ParaSetReader100()
{
	initValveMap();
	readIniFile();
	m_params = NULL;
...
int ParaSetReader100::readIniFile()
{
	//检定前的参数文件
...
Verify_Params_PTR ParaSetReader100::getParams()
{
	readIniFile();
	readParamValues();
	return m_params;
...
** 端口字段对应
*/
void ParaSetReader100::initValveMap()
{
...
** 读取配置文件的信息
*/
void ParaSetReader100::readParamValues()
{
	readHead();
	readBool();
	readOther();
...
void ParaSetReader100::readHead()
{
...
void ParaSetReader100::readFlowPoints()
{
...
void ParaSetReader100::readBool()
{
...
void ParaSetReader100::readOther()
{
...
void ParaSetReader100::readWaterPara()
{
...
*/
Flow_Point_Info ParaSetReader100::getFpBySeq(int i)
{
...
int ParaSetReader100::getBigSmallBySeq(int i)
{
