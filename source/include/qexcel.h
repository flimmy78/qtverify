...
#ifdef QEXCEL_DLL
#  ifdef WIN32
#  define QEXCEL_EXPORT __declspec(dllexport)
#  else
#  define QEXCEL_EXPORT
#  endif
#else
#  ifdef WIN32
#  define QEXCEL_EXPORT __declspec(dllimport)
#  else
#  define QEXCEL_EXPORT
#  endif
#endif
...
class QEXCEL_EXPORT QExcel : public QObject
{
public:
...
public:
	...
	void unmergeCells(const QString& range);
