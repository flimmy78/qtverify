...
ALGORITHM_EXPORT float calcTemperByResis(float resis);//根据标准铂电阻的阻值和事先设定的参数，计算标准铂电阻的温度值
...
ALGORITHM_EXPORT UINT16 CRC16ModRTU_Table_Driven (const uchar *nData, UINT16 wLength);//查表法计算modbus-RTU协议的CRC校验值
