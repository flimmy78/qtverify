...
#ifdef QTEXDB_DLL
#  ifdef WIN32
#  define EXCELENGINE_EXPORT __declspec(dllexport)
#  else
#  define EXCELENGINE_EXPORT
#  endif
#else
#  ifdef WIN32
#  define EXCELENGINE_EXPORT __declspec(dllimport)
#  else
#  define EXCELENGINE_EXPORT
#  endif
#endif
...
/**
  ...
  *@date
  */
class EXCELENGINE_EXPORT ExcelEngine : protected QObject
{
public:
    ExcelEngine();
