...
FlowWeightResultDlg::FlowWeightResultDlg(QWidget *parent, Qt::WFlags flags)
...
FlowWeightResultDlg::~FlowWeightResultDlg()
{

}

void FlowWeightResultDlg::initUiData()
{
	//制造单位
	int col_id1 = 0;
...
//查询检定结果
void FlowWeightResultDlg::on_btnQuery_clicked()
{
	getConditon();
...
void FlowWeightResultDlg::getConditon()
{
	m_conStr.clear();
...
void FlowWeightResultDlg::on_btnInsert_clicked()
{
...
void FlowWeightResultDlg::on_btnStop_clicked()
{
	m_count = 1;
	qDebug()<<"on_btnStop_clicked, m_count ="<<m_count;
}

void FlowWeightResultDlg::on_btnExport_clicked()
{
	if (NULL==model)
	{
...
void FlowWeightResultDlg::on_btnExit_clicked()
{
	this->close();
}
